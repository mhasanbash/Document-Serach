...
└─────────────┘                            └────────┬────────┘
                                                     │
                                                     │ 1. ذخیره فایل در دیتابیس
                                                     │ 2. فراخوانی ChromaService
                                                     ▼
                                            ┌─────────────────┐
                                            │  ChromaService   │
                                            └────────┬────────┘
                                                     │
                                                     │ • استخراج متن (KreuzbergLoader)
                                                     │ • تقسیم به تکه‌ها (RecursiveSplitter)
                                                     │ • تولید بردار (OpenAI Embeddings)
                                                     ▼
                                            ┌─────────────────┐
                                            │     Chroma       │
                                            │ (ذخیره‌ساز برداری)│
